...
class Ng2FlatpickrModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: Ng2FlatpickrModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.0.8", ngImport: i0, type: Ng2FlatpickrModule, declarations: [Ng2FlatpickrComponent, Ng2FlatpickrDirective], imports: [CommonModule], exports: [Ng2FlatpickrComponent, Ng2FlatpickrDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: Ng2FlatpickrModule, imports: [CommonModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.0.8", ngImport: i0, type: Ng2FlatpickrModule, decorators: [{
            type: NgModule,
            args: [{
