  ...
  implements AfterViewInit, OnDestroy, OnInit, OnChanges
{
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<
    ...
    ["ng2-flatpickr"],
    {
      flatpickrOptions: { alias: "flatpickr"; required: false };
      placeholder: { alias: "placeholder"; required: false };
      flatpickrAltFormat: { alias: "altFormat"; required: false };
      flatpickrAltInput: { alias: "altInput"; required: false };
      flatpickrAltInputClass: { alias: "altInputClass"; required: false };
      flatpickrAllowInput: { alias: "allowInput"; required: false };
      flatpickrAppendTo: { alias: "appendTo"; required: false };
      flatpickrClickOpens: { alias: "clickOpens"; required: false };
      flatpickrDateFormat: { alias: "dateFormat"; required: false };
      flatpickrDefaultDate: { alias: "defaultDate"; required: false };
      flatpickrDisable: { alias: "disable"; required: false };
      flatpickrDisableMobile: { alias: "disableMobile"; required: false };
      flatpickrEnable: { alias: "enable"; required: false };
      flatpickrEnableTime: { alias: "enableTime"; required: false };
      flatpickrEnableSeconds: { alias: "enableSeconds"; required: false };
      flatpickrHourIncrement: { alias: "hourIncrement"; required: false };
      flatpickrInline: { alias: "inline"; required: false };
      flatpickrLocale: { alias: "locale"; required: false };
      flatpickrMaxDate: { alias: "maxDate"; required: false };
      flatpickrMinDate: { alias: "minDate"; required: false };
      flatpickrMinuteIncrement: { alias: "minuteIncrement"; required: false };
      flatpickrMode: { alias: "mode"; required: false };
      flatpickrNextArrow: { alias: "nextArrow"; required: false };
      flatpickrNoCalendar: { alias: "noCalendar"; required: false };
      flatpickrParseDate: { alias: "parseDate"; required: false };
      flatpickrPrevArrow: { alias: "prevArrow"; required: false };
      flatpickrShorthandCurrentMonth: {
        alias: "shorthandCurrentMonth";
        required: false;
      };
      flatpickrStatic: { alias: "static"; required: false };
      flatpickrTime_24hr: { alias: "time_24hr"; required: false };
      flatpickrUtc: { alias: "utc"; required: false };
      flatpickrWeekNumbers: { alias: "weekNumbers"; required: false };
      flatpickrWrap: { alias: "wrap"; required: false };
    },
    {
