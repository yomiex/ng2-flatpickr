  ...
  implements AfterViewInit, OnDestroy, OnInit, OnChanges
{
   ...
   * Default:  null
   */
  @Input("defaultDate") public flatpickrDefaultDate:
    | string
    | Date
    | string[]
    | Date[]
   ...
   * Default:  []
   */
  @Input("disable") public flatpickrDisable:
    | string[]
    | Date[]
    | Function
    | undefined;
   ...
   * Default:  []
   */
  @Input("enable") public flatpickrEnable:
    | string[]
    | Date[]
    | Function
    | undefined;
   ...
   * Default:  false
   */
  @Input("shorthandCurrentMonth") public flatpickrShorthandCurrentMonth:
    | boolean
    | undefined;
